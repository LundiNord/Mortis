//Usando o mergesort implementado na pagina de DAA
...
public class prob05 {
	...
	if (start<end) {                 // Parar quando tamanho do array < 2
		...
		inversions += mergesort(v, start, middle);   // Ordenar metade esquerda
	    inversions += mergesort(v, middle+1, end);   // Ordenar metade direita
	    inversions += merge(v, start, middle, end);  // Combinar duas metades ordenadas
	}
