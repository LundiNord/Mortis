...
class Inversoes {
    ...
    static void merge(int v[], int start, int middle, int end) {
        ...
        while (p1<=middle && p2<=end) {            // Enquanto de para comparar
            ...
            else               {contador+=(middle-p1)+1; aux[i++] = v[p2++]; }          //contador p.e queremos trocar [3,4] com [1] para o 1 estar na primeira posiçao sao precisos duas trocas (imaginando como se fosse feito a força bruta) [4,1] e depois [3,1] ficando [1,3,4]
