...
class Graph{
	...
	public void verifica () {
		for(int i=1; i<npessoas; i++) {
			//System.out.println(alunosT[i].id + " " + alunosT[i].visited );
		}
		for(No cursor : gt[2].adj) {
			System.out.println(cursor.no + " " + cursor.visitado);
		}
	}
}
