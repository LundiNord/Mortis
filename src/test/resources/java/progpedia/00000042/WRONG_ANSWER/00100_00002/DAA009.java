    ...
    public static void main (String args[]) {
        ...
        for (int j=0; j<n && end < m; j++) {
            ...
            if (e[j].start <= end) {
                ...
                if(e[j].size >= e[j+1].size) { counter++; end=e[j].end; }
                if(e[j+1].size > e[j].size) { counter++; end=e[j+1].end; }
            }
            
        }
            
            //System.out.println(j);
            /*if (e[j].start <= end && e[j].end >= end) {
                if (e[j].end >= e[j+1].end) {
                    System.out.println("[" + e[j].start + "," + e[j].end + "]");
                    end = e[j].end;
                }
                if (e[j+1].end >= e[j].end && e[j+1].end >= end) {
                    System.out.println("[" + e[j+1].start + "," + e[j+1].end + "]");
                    end = e[j+1].end;
                }
            }*/
