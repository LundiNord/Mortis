...
public class main {
	...
	public static void main(String[] args) {
		...
		while ((ext1 = stdin.nextInt()) != -1) {
			ext2 = stdin.nextInt();
			largura = stdin.nextInt();
			comprimento = stdin.nextInt();
			altura = stdin.nextInt();
			if (largura >= lMinima && comprimento >= cMinimo
					&& altura >= aMinima) {
				g.insert_new_arc(ext1, ext2, largura);
				g.insert_new_arc(ext2, ext1, largura);
			}
		}
