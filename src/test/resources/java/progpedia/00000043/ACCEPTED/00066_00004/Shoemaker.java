...
class Shoes implements Comparable<Shoes> {
    ...
    Shoes(int duration, int penalty, double ratio, int pos) {
...
public class Shoemaker {
    ...
    static void readInput() {
        ...
        for( int i = 0; i < num_shoes; i++ ) {
            d = in.nextInt();
            p = in.nextInt();                   // Para devolver o resultado da divisão de dois inteiros como double
            r = (double)p/d;                    // usamos "(double)"
    ...
    public static void main( String[] args ) {
        ...
        System.out.println( sh[num_shoes-1].pos );
