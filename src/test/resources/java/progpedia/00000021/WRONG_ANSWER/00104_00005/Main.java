			...
			for(Integer ligacao : ligacoes)
			{
				if(!visitadas.containsKey(ligacao))
				{
					...
					if(
						...
						&& (disAni.obterCompMin() <= melhorTempoActualClone) && (melhorTempoActualClone <= disAni.obterCompMax())
...
public class Main 
{
	...
	public static void main(String[] args) 
	{
		...
		visited = new HashMap<Integer,Void>();
		visited.put(fim,null);
		
		grafo.encontrarRecursivo(visited,fim,comeco,disAni,new Integer(Integer.MAX_VALUE));
