 ...
 class p15{
    ...
    static boolean visited[];  // Que nos ja foram visitados?
 	...
 	public static void main(String [] args){
		...
		// Ideia: para cada v ainda n visitado fazer pesquisa em prof para esse v
		// dfs vai marcar os visitados de cada componente conexa
		...
		if( edges == 0 && n != 0) // um componente e conexo dele proprio
