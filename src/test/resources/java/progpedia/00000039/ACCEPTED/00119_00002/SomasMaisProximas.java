...
public class SomasMaisProximas {
	...
	static int bsearch(int [] v, int low, int high, int key){
		...
		middle = low;
		//System.out.println("!"+v[middle] +" " +  (key - v[middle - 1] )+ " " +( v[middle] - key));
		//System.out.println(" " + middle);
		if(middle > 0 && middle < tam){ //feito com ajuda
	...
	public static void main(String args []){
		...
		/*for(int i = 0; i < pos; i++)
			System.out.print(soma[pos]);*/
		
		Arrays.sort(soma); //Ordenar o vector soma
