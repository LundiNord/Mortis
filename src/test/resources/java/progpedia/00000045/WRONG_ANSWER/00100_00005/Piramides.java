...
//		System.out.println("Returning four "+four+" line/pos "+linha+ " "+posicao);
	...
	for(int i=1; i<N+1; i++){
	    ...
	    if(i>1 && i<N){
		if(!isLoose(1, i)){
		    int one = whiteRabbit(2, i-1);
		    int two = whiteRabbit(2, i);
		    contador += one+two;
		}
