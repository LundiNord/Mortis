...
class Builder
{
	 ...
	 * 	-uma matriz de pesos;
	 * 	-um no inicial
	 * ESTE DIJKSTRA usa ainda a propriadade "nome" de cada no
	 * que nos indica o numedo da loja*/
...
public class NegocioElectronico {
	...
	public static void main(String args[])
	{
		...
		/*O programa diz a cada no
		 * qual e o nome dos seus filhos
		 * e coloca os pesos na matriz*/
		boolean ciclo=false;
		while(ciclo==false)
		{
