...
public class Problema3B{
    public static void main(String[] args) {
        ...
        while (t == true){
            ...
            int j = in.nextInt();
            int dist = in.nextInt();
            g.insert_new_arc(i, j, dist);
            g.insert_new_arc(j, i, dist);
        }  
        algoritmoDijkstra(g, destino);
    }
    
    static void algoritmoDijkstra (Grafo g, int origem){
            ...
            Heapmin q = new Heapmin(dist, dist.length-1);
            ...
            while(q.size!=0){
                ...
                for(Arco w : g.verts[v].adjs)
                    if(dist[v] != Integer.MAX_VALUE && dist[v]+w.valor < dist[w.no_final]){
