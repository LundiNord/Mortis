...
public class prat21 {
    static ArrayList<LinkedList<Integer>> nodeMap = new ArrayList<LinkedList<Integer>>();
	...
	for (int i = 0; i < nv+1; i++) {
	    if (excentricidade(i) < raio && excentricidade(i) != 0) raio = excentricidade(i);
	}
